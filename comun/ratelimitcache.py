...
class ratelimit(object):
    ...
    def view_wrapper(self, request, fn, *args, **kwargs):
        ...
        # Have they failed?
        suma = sum(int(i) for i in counts)
        if suma >= self.requests:
            print >> stderr, 'rate limit!', suma, self.requests
    ...
    def disallowed(self, request):
        ...
        return HttpResponseForbidden(u'Por prevención, se ha bloqueado el acceso temporalmente. Inténtalo de nuevo dentro de tres minutos.')
